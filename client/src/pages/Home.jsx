    ...
    <div className="home">
      <div className="home-container">
        ...
        <svg 
          ...
          title={language === 'ja' ? 'ロゴをトリプルクリック' : 'Triple-click the logo to toggle language'}
        >
          <g>
        ...
        <div className="home-buttons">
          ...
          <p className="terms">
            ...
            <a href="#">{t('privacyPolicy')}</a> ({t('cookieUsage')} <a href="#">{t('cookiePolicy')}</a>) {t('agreeText')}
          </p>
        </div>
        ...
        <div className="signin-section">
          ...
          >
            ...
            {t('helpFriendRecovery')}
          </button>
        </div>

        <footer className="home-footer">
          <a href="#">{t('overview')}</a>
          <a href="#">{t('downloadApp')}</a>
          ...
          <a href="#">{t('blog')}</a>
          <a href="#">{t('careers')}</a>
          <a href="#">{t('brandResources')}</a>
          <a href="#">{t('ads')}</a>
          <a href="#">{t('marketing')}</a>
          <a href="#">{t('business')}</a>
          <a href="#">{t('developers')}</a>
          <a href="#">{t('directory')}</a>
          <a href="#">{t('settings')}</a>
